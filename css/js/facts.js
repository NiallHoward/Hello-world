$(document).ready(function(){
	var facts = ["Banging your head against a wall for one hour burns 150 calories.",
	...
	document.getElementById("fact").innerHTML = "<strong>Fact of the day:</strong> " + randomFacts;
